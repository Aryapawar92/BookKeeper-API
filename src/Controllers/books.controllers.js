...
const addBook = asyncHandler(async (req,res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200,newBook,"Book Added Successfully")
    )
...
const updateBook = asyncHandler(async (req,res) => {
    ...
    const updated = await Book.findOneAndUpdate({ISBN},
        {
            $set:{
                title:newTitle,
    ...
    return res.status(200).json(
        new ApiResponse(200,updateBook,"Book Updated Successully")
    )
